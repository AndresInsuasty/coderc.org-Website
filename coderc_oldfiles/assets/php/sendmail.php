...
|
*/
$reciever        = "director@coderc.org";
$default_subject = "director@coderc.org";

$sender_email    = "director@coderc.org";
$sender_name     = "coderc.org";
$error_message   = "Ocurrió un error, por favor intenta más tarde";
